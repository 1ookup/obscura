#!/usr/bin/env bash
# Bind two v8::ObjectTemplate methods rusty_v8 v137.3.0 leaves unbound.
#
...
python3 - "$V8_DIR/src/binding.cc" "$V8_DIR/src/template.rs" <<'PY'
import sys

binding_path, template_path = sys.argv[1], sys.argv[2]
