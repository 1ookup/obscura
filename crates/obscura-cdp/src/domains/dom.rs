    ...
    if let Some(oid) = params.get("objectId").and_then(|v| v.as_str()) {
        let code = format!(
            "(function() {{ var o = globalThis.__obscura_objects && globalThis.__obscura_objects['{}']; \
             return (o && typeof o[Symbol.for('obscura.nid')] === 'number') ? o[Symbol.for('obscura.nid')] : -1; }})()",
            oid.replace('\'', "\\'")
        );
    ...
    match method {
        ...
        "describeNode" => {
                ...
                .or_else(|| params.get("backendNodeId").and_then(|v| v.as_u64()))
            {
                ...
                let code = format!(
                    "(function() {{ var o = globalThis.__obscura_objects['{}']; if (!o) return -1; return (typeof o[Symbol.for('obscura.nid')] === 'number') ? o[Symbol.for('obscura.nid')] : -1; }})()",
                    escaped_oid
                );
                let result = page.evaluate(&code);
        ...
        "resolveNode" => {
                ...
                .or_else(|| params.get("backendNodeId").and_then(|v| v.as_u64()))
            {
                ...
                let code = format!(
                    "(function() {{ var o = globalThis.__obscura_objects['{}']; return (o && typeof o[Symbol.for('obscura.nid')] === 'number') ? o[Symbol.for('obscura.nid')] : -1; }})()",
                    oid
                );
                let result = page.evaluate(&code);
                result.as_f64().map(|n| n as u64).unwrap_or(0)
